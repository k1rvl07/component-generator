...
function activate(context) {
  ...
  const disposable = vscode.commands.registerCommand("extension.createComponent", (uri) =>
...
function checkAndCopyPlopFiles(extensionPath, workspaceRoot) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (!isPlopInstalled) {
      const installPlop = yield vscode.window.showInformationMessage(
    ...
    if (!fs.existsSync(templatesDir)) {
      const createTemplatesDir = yield vscode.window.showInformationMessage(
...
function checkAndSetupBiome(workspaceRoot, extensionPath) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (!isBiomeInstalled && !isBiomeJsonExists) {
      const installBiomeAndAddConfig = yield vscode.window.showInformationMessage(
      ...
      const addBiomeConfig = yield vscode.window.showInformationMessage(
      ...
      const installBiomeOption = yield vscode.window.showInformationMessage(
...
function checkPlopInstalled(workspaceRoot) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    return (
      ((_a = packageJson.dependencies) === null || _a === void 0 ? void 0 : _a.plop) ||
      ((_b = packageJson.devDependencies) === null || _b === void 0 ? void 0 : _b.plop)
    );
  });
}
...
function checkAndUpdatePlopFile(extensionPlopFile, plopFilePath) {
  return __awaiter(this, void 0, void 0, function* () {
    if (!fs.existsSync(plopFilePath)) {
      const createPlopFile = yield vscode.window.showInformationMessage(
...
function checkAndUpdateComponentGenerator(extensionGeneratorsDir, plopGeneratorsDir) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (!fs.existsSync(plopGeneratorsDir)) {
      const createGeneratorsDir = yield vscode.window.showInformationMessage(
      ...
      if (!fs.existsSync(componentGeneratorPath)) {
        const createComponentGenerator = yield vscode.window.showInformationMessage(
        ...
        if (userContent !== defaultContent) {
          const restoreGenerator = yield vscode.window.showInformationMessage(
...
function checkMissingAndModifiedTemplates(extensionTemplatesDir, templatesDir) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (missingFiles.length > 0) {
      const addAll = yield vscode.window.showInformationMessage(
    ...
    if (modifiedFiles.length > 0) {
      const restoreAll = yield vscode.window.showInformationMessage(
...
function promptUserForComponentData(_folderPath, relativePath) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const componentType = yield promptForSelection(
    ...
    const style = yield promptForSelection(
    ...
    const stories = yield promptForSelection(
      ["No", "Yes"],
    ...
    const testFramework = yield promptForSelection(
    ...
    const contextOption = yield promptForSelection(
      ["No", "Yes"],
    ...
    const folderStructure = yield promptForSelection(
      ["Flat", "Grouped"],
